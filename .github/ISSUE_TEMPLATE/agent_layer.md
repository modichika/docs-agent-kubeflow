---
name: 🤖 3.1 Kagent Agent Layer Issue
about: File an issue related to Kagent agent behavior, model config, or tool wiring.
title: "[agent]: "
labels: ["component:agent", "triage-needed", "llm"]
---
